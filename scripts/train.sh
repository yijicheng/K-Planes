# PYTHONPATH='.' python plenoxels/main.py --config-path plenoxels/configs/final/NeRF/nerf_hybrid.py
...
PYTHONPATH='.' python plenoxels/main.py --config-path plenoxels/configs/ngp/RodinSubject/nerf_hybrid.py
